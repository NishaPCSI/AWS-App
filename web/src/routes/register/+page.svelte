...
<div class="center-container">
    <form on:submit|preventDefault={register}>
        ...
        <input bind:this={full_name_node} required type="text" name="full_name" id="full_name">
        
        <label for="email">Email</label>
        <input bind:this={email_node} required type="email" name="email" id="email">
        
        <label for="dob">Date of Birth</label>
        <input bind:this={dob_node} required type="date" name="dob" id="dob">
        
        <label for="password">Password</label>
        <input required bind:this={password_node} type="password" name="password" id="password">
        
        <label for="confirm_password">Confirm Password</label>
        <input required bind:this={confirm_password_node} type="password" name="confirm_password" id="confirm_password">
        
        <div class="error">{error_text}</div>
        <ThemedButton type={"submit"} --bgcolor="var(--on-background)" --color="var(--background)">Register</ThemedButton>
